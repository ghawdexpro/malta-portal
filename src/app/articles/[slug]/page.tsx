      ...
      <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-white">
          ...
          <div className="mt-5 flex items-center gap-6 text-sm text-white/50">
            <span>{article.source_count} community sources</span>
            <span>&#8226;</span>
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        {clips.length > 0 && (
          <section className="mt-16 rounded-2xl bg-malta-dark p-8 md:p-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-extrabold text-white">
                  Robert Maklowicz on This Topic
                </h3>
                <p className="text-xs text-white/50">
                  Watch relevant clips from his Malta journey
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              ...
              >
                Explore Full Maklowicz Journey
        ...
        {article.tags && article.tags.length > 0 && (
          <div className="mt-12 border-t border-gray-100 pt-8">
            <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Topics</p>
        ...
        <div className="mt-12 rounded-2xl bg-malta-stone p-8 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
            Every article is generated from real tourist discussions, analyzed by AI, and enriched with video content from Robert Maklowicz.
          </p>
