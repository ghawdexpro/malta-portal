...
const BATCH_3_SLUGS = [
    'pl-prom-na-gozo',
    'pl-konkatedra-sw-jana',
    'pl-fortyfikacje-malty',
    'pl-swiatynie-starsze-od-piramid',
    'pl-maltanskie-jedzenie-uliczne',
    'pl-maltanskie-wino-rewolucja',
    'pl-katakumby-swietego-pawla',
    'pl-mdina-noca-wino-cisza'
];
